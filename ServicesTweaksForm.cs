...
{
    public partial class ServicesTweaksForm : Form
    {
        ...
        public ServicesTweaksForm()
        {
            InitializeComponent();
        }

        string CurrentServicesConfig = "";

        private void ServicesTweaksForm_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Settings.GetValue("ServicesConfig") != null)
                {
                    ComboBoxServicesConfig.Text = Settings.GetValue("ServicesConfig").ToString();
                }
                else
                {
                    ComboBoxServicesConfig.Text = "Unknown";
                }

                CurrentServicesConfig = ComboBoxServicesConfig.Text;

                if (System.GetValue("EnableLUA").ToString() == "1")
                {
                    if (MessageBox.Show("You seem to have UAC enabled. You must disable UAC to continue. Do you want to disable UAC now?", "User Account Control", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    {
                        System.SetValue("EnableLUA", "0", RegistryValueKind.DWord);
                    }
                    else
                    {
                        MessageBox.Show("You can't disable services if you have UAC enabled.", "User Account Control", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        this.Close();
                    }
                }
            }
        ...
        private void ButtonOK_Click(object sender, EventArgs e)
        {
            ...
            if (CurrentServicesConfig == ComboBoxServicesConfig.Text)
            {
            }
            else
            {
                if (ComboBoxServicesConfig.Text == "Bare 7")
                {
                    if (Services.GetSubKeyNames().Contains("AeLookupSvc"))
                    {
                        RegistryKey AeLookupSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AeLookupSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        AeLookupSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Appinfo"))
                    {
                        ...
                        Appinfo.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("aspnet_state"))
                    {
                        RegistryKey aspnet_state = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\aspnet_state", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        aspnet_state.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("BDESVC"))
                    {
                        RegistryKey BDESVC = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\BDESVC", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        BDESVC.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("BFE"))
                    {
                        ...
                        BFE.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Browser"))
                    {
                        RegistryKey Browser = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\Browser", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        Browser.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("bthserv"))
                    {
                        ...
                        bthserv.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("clr_optimization_v2.0.50727_32"))
                    {
                        RegistryKey clroptimizationv2_32 = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\clr_optimization_v2.0.50727_32", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        clroptimizationv2_32.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("clr_optimization_v2.0.50727_64"))
                    {
                        RegistryKey clroptimizationv2_64 = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\clr_optimization_v2.0.50727_64", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        clroptimizationv2_64.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("clr_optimization_v4.0.30319_32"))
                    {
                        RegistryKey clroptimizationv4_32 = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\clr_optimization_v4.0.30319_32", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        clroptimizationv4_32.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("clr_optimization_v4.0.30319_64"))
                    {
                        RegistryKey clroptimizationv4_64 = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\clr_optimization_v4.0.30319_64", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        clroptimizationv4_64.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("CryptSvc"))
                    {
                        ...
                        CryptSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("DiagTrack"))
                    {
                        RegistryKey DiagTrack = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\DiagTrack", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        DiagTrack.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Dnscache"))
                    {
                        ...
                        Dnscache.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("dot3svc"))
                    {
                        ...
                        dot3svc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("ehRecvr"))
                    {
                        RegistryKey ehRecvr = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\ehRecvr", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        ehRecvr.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("ehSched"))
                    {
                        RegistryKey ehSched = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\ehSched", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        ehSched.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("eventlog"))
                    {
                        ...
                        eventlog.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Fax"))
                    {
                        RegistryKey Fax = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\Fax", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        Fax.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("hkmsvc"))
                    {
                        RegistryKey hkmsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\hkmsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        hkmsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("HomeGroupProvider"))
                    {
                        RegistryKey HomeGroupProvider = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\HomeGroupProvider", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        HomeGroupProvider.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("idsvc"))
                    {
                        RegistryKey idsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\idsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        idsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("IEEtwCollectorService"))
                    {
                        RegistryKey IEEtwCollectorService = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\IEEtwCollectorService", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        IEEtwCollectorService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("IPBusEnum"))
                    {
                        RegistryKey IPBusEnum = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\IPBusEnum", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        IPBusEnum.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Mcx2Svc"))
                    {
                        RegistryKey Mcx2Svc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\Mcx2Svc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        Mcx2Svc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("MMCSS"))
                    {
                        RegistryKey MMCSS = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\MMCSS", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        MMCSS.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("napagent"))
                    {
                        RegistryKey napagent = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\napagent", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        napagent.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Netman"))
                    {
                        ...
                        Netman.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("NetMsmqActivator"))
                    {
                        RegistryKey NetMsmqActivator = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\NetMsmqActivator", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        NetMsmqActivator.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("NetPipeActivator"))
                    {
                        RegistryKey NetPipeActivator = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\NetPipeActivator", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        NetPipeActivator.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("netprofm"))
                    {
                        ...
                        netprofm.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("NetTcpActivator"))
                    {
                        RegistryKey NetTcpActivator = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\NetTcpActivator", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        NetTcpActivator.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("NlaSvc"))
                    {
                        ...
                        NlaSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("nsi"))
                    {
                        ...
                        nsi.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("ProtectedStorage"))
                    {
                        RegistryKey ProtectedStorage = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\ProtectedStorage", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        ProtectedStorage.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Schedule"))
                    {
                        ...
                        Schedule.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("sppuinotify"))
                    {
                        RegistryKey sppuinotify = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\sppuinotify", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        sppuinotify.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("SysMain"))
                    {
                        RegistryKey SysMain = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\SysMain", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        SysMain.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("THREADORDER"))
                    {
                        RegistryKey THREADORDER = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\THREADORDER", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        THREADORDER.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("UI0Detect"))
                    {
                        RegistryKey UI0Detect = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\UI0Detect", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        UI0Detect.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("UxSms"))
                    {
                        RegistryKey UxSms = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\UxSms", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        UxSms.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("vds"))
                    {
                        ...
                        vds.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("WatAdminSvc"))
                    {
                        RegistryKey WatAdminSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WatAdminSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WatAdminSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("WcsPlugInService"))
                    {
                        RegistryKey WcsPlugInService = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WcsPlugInService", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WcsPlugInService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("WMPNetworkSvc"))
                    {
                        RegistryKey WMPNetworkSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WMPNetworkSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WMPNetworkSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("WPCSvc"))
                    {
                        RegistryKey WPCSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WPCSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WPCSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("wscsvc"))
                    {
                        RegistryKey wscsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\wscsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        wscsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("wudfsvc"))
                    {
                        RegistryKey wudfsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\wudfsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        wudfsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (MessageBox.Show("Are you using a laptop?", "Laptop", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    {
                        if (Services.GetSubKeyNames().Contains("hidserv"))
                        {
                            RegistryKey hidserv = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\hidserv", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    if (MessageBox.Show("Are you using Wi-Fi?", "Wi-Fi", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    {
                        if (Services.GetSubKeyNames().Contains("WlanSvc"))
                        {
                            RegistryKey WlanSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WlanSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    MessageBox.Show("Succesfully disabled services.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                else if (ComboBoxServicesConfig.Text == "Default 7")
                {
                    if (Services.GetSubKeyNames().Contains("AeLookupSvc"))
                    {
                        RegistryKey AeLookupSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AeLookupSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        AeLookupSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey BDESVC = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\BDESVC", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        BDESVC.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey BITS = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\BITS", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        BITS.SetValue("Start", "2", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("Browser"))
                    {
                        RegistryKey Browser = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\Browser", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        Browser.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey clroptimizationv4_32 = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\clr_optimization_v4.0.30319_32", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        clroptimizationv4_32.SetValue("Start", "2", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("clr_optimization_v4.0.30319_64"))
                    {
                        RegistryKey clroptimizationv4_64 = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\clr_optimization_v4.0.30319_64", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        clroptimizationv4_64.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey CscService = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\CscService", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        CscService.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey DiagTrack = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\DiagTrack", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        DiagTrack.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey ehRecvr = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\ehRecvr", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        ehRecvr.SetValue("Start", "3", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("ehSched"))
                    {
                        RegistryKey ehSched = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\ehSched", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        ehSched.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey Fax = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\Fax", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        Fax.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey hkmsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\hkmsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        hkmsvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("HomeGroupProvider"))
                    {
                        RegistryKey HomeGroupProvider = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\HomeGroupProvider", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        HomeGroupProvider.SetValue("Start", "3", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("idsvc"))
                    {
                        RegistryKey idsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\idsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        idsvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("IEEtwCollectorService"))
                    {
                        RegistryKey IEEtwCollectorService = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\IEEtwCollectorService", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        IEEtwCollectorService.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey IPBusEnum = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\IPBusEnum", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        IPBusEnum.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey lmhosts = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\lmhosts", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        lmhosts.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey MMCSS = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\MMCSS", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        MMCSS.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey napagent = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\napagent", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        napagent.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey PcaSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\PcaSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        PcaSvc.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey PlugPlay = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\PlugPlay", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        PlugPlay.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey ProtectedStorage = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\ProtectedStorage", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        ProtectedStorage.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey RemoteRegistry = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\RemoteRegistry", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        RemoteRegistry.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey Spooler = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\Spooler", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        Spooler.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey sppuinotify = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\sppuinotify", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        sppuinotify.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey StorSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\StorSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        StorSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey SysMain = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\SysMain", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        SysMain.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey THREADORDER = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\THREADORDER", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        THREADORDER.SetValue("Start", "3", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("UI0Detect"))
                    {
                        RegistryKey UI0Detect = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\UI0Detect", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        UI0Detect.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey UxSms = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\UxSms", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        UxSms.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey WatAdminSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WatAdminSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WatAdminSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey WcsPlugInService = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WcsPlugInService", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WcsPlugInService.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey WerSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WerSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WerSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey WlanSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WlanSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WlanSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey WMPNetworkSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WMPNetworkSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WMPNetworkSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("WPCSvc"))
                    {
                        RegistryKey WPCSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WPCSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WPCSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey wscsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\wscsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        wscsvc.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey wuauserv = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\wuauserv", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        wuauserv.SetValue("Start", "2", RegistryValueKind.DWord);
                    }

                    if (Services.GetSubKeyNames().Contains("wudfsvc"))
                    {
                        RegistryKey wudfsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\wudfsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        wudfsvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    MessageBox.Show("Succesfully restored default services.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    MessageBox.Show("Your changes will not take effect until your computer is restarted.", "Restart", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else if (ComboBoxServicesConfig.Text == "Bare 8.1")
                {
                    if (Services.GetSubKeyNames().Contains("AeLookupSvc"))
                    {
                        RegistryKey AeLookupSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AeLookupSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    if (Services.GetSubKeyNames().Contains("BthHFSrv"))
                    {
                        RegistryKey BthHFSrv = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\BthHFSrv", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        BthHFSrv.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("MsKeyboardFilter"))
                    {
                        RegistryKey MsKeyboardFilter = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\MsKeyboardFilter", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        MsKeyboardFilter.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("PrintNotify"))
                    {
                        RegistryKey PrintNotify = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\PrintNotify", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        PrintNotify.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey QWAVE = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\QWAVE", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        QWAVE.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("SystemEventsBroker"))
                    {
                        ...
                        SystemEventsBroker.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("TimeBroker"))
                    {
                        RegistryKey TimeBroker = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\TimeBroker", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        TimeBroker.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("Wcmsvc"))
                    {
                        ...
                        Wcmsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("workfolderssvc"))
                    {
                        RegistryKey workfolderssvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\workfolderssvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        workfolderssvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("WSService"))
                    {
                        RegistryKey WSService = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WSService", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WSService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                ...
                else if (ComboBoxServicesConfig.Text == "Default 8.1")
                {
                    if (Services.GetSubKeyNames().Contains("AeLookupSvc"))
                    {
                        RegistryKey AeLookupSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AeLookupSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    {
                        RegistryKey BthHFSrv = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\BthHFSrv", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        BthHFSrv.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey PrintNotify = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\PrintNotify", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        PrintNotify.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey RasMan = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\RasMan", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        RasMan.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey TimeBroker = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\TimeBroker", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        TimeBroker.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey workfolderssvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\workfolderssvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        workfolderssvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey WSService = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\WSService", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        WSService.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                ...
                else if (ComboBoxServicesConfig.Text == "Bare 1709")
                {
                    ...
                    if (Services.GetSubKeyNames().Contains("camsvc"))
                    {
                        ...
                        camsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("irmon"))
                    {
                        RegistryKey irmon = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\irmon", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        irmon.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("tiledatamodelsvc"))
                    {
                        RegistryKey tiledatamodelsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\tiledatamodelsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        tiledatamodelsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("TimeBrokerSvc"))
                    {
                        ...
                        TimeBrokerSvc.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("OneSyncSvc"))
                    {
                        RegistryKey OneSyncSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\OneSyncSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        OneSyncSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("WpnUserService"))
                    {
                        ...
                        WpnUserService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                ...
                else if (ComboBoxServicesConfig.Text == "Default 1709")
                {
                    if (Services.GetSubKeyNames().Contains("AJRouter"))
                    {
                        RegistryKey AJRouter = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AJRouter", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    {
                        RegistryKey irmon = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\irmon", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        irmon.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey tiledatamodelsvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\tiledatamodelsvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        tiledatamodelsvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey UsoSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\UsoSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        UsoSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey OneSyncSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\OneSyncSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        OneSyncSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                ...
                else if (ComboBoxServicesConfig.Text == "Bare 2004")
                {
                    if (Services.GetSubKeyNames().Contains("AJRouter"))
                    {
                        RegistryKey AJRouter = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AJRouter", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    if (Services.GetSubKeyNames().Contains("BTAGService"))
                    {
                        ...
                        BTAGService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("BthAvctpSvc"))
                    {
                        ...
                        BthAvctpSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey ClipSVC = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\ClipSVC", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        ClipSVC.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("MixedRealityOpenXRSvc"))
                    {
                        RegistryKey MixedRealityOpenXRSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\MixedRealityOpenXRSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        MixedRealityOpenXRSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("perceptionsimulation"))
                    {
                        RegistryKey perceptionsimulation = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\perceptionsimulation", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        perceptionsimulation.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("SharedRealitySvc"))
                    {
                        RegistryKey SharedRealitySvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\SharedRealitySvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        SharedRealitySvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("spectrum"))
                    {
                        RegistryKey spectrum = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\spectrum", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        spectrum.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("VacSvc"))
                    {
                        RegistryKey VacSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\VacSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        VacSvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("BcastDVRUserService"))
                    {
                        ...
                        BcastDVRUserService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("BluetoothUserService"))
                    {
                        ...
                        BluetoothUserService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                    ...
                    if (Services.GetSubKeyNames().Contains("cbdhsvc"))
                    {
                        ...
                        cbdhsvc.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                ...
                else if (ComboBoxServicesConfig.Text == "Default 2004")
                {
                    if (Services.GetSubKeyNames().Contains("AJRouter"))
                    {
                        RegistryKey AJRouter = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AJRouter", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    {
                        RegistryKey DoSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\DoSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        DoSvc.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey MixedRealityOpenXRSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\MixedRealityOpenXRSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        MixedRealityOpenXRSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey perceptionsimulation = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\perceptionsimulation", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        perceptionsimulation.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey SharedRealitySvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\SharedRealitySvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        SharedRealitySvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey spectrum = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\spectrum", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        spectrum.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey VacSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\VacSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        VacSvc.SetValue("Start", "3", RegistryValueKind.DWord);
                    }
                    ...
                    {
                        RegistryKey OneSyncSvc = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\OneSyncSvc", RegistryKeyPermissionCheck.ReadWriteSubTree);
                        OneSyncSvc.SetValue("Start", "2", RegistryValueKind.DWord);
                    }
                ...
                else if (ComboBoxServicesConfig.Text == "Bare 2009")
                {
                    if (Services.GetSubKeyNames().Contains("AJRouter"))
                    {
                        RegistryKey AJRouter = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AJRouter", RegistryKeyPermissionCheck.ReadWriteSubTree);
                    ...
                    if (Services.GetSubKeyNames().Contains("CaptureService"))
                    {
                        ...
                        CaptureService.SetValue("Start", "4", RegistryValueKind.DWord);
                    }
                ...
                else if (ComboBoxServicesConfig.Text == "Default 2009")
                {
                    if (Services.GetSubKeyNames().Contains("AJRouter"))
                    {
                        RegistryKey AJRouter = Registry.LocalMachine.OpenSubKey(@"SYSTEM\CurrentControlSet\Services\AJRouter", RegistryKeyPermissionCheck.ReadWriteSubTree);
            ...
            Settings.SetValue("ServicesConfig", ComboBoxServicesConfig.Text);
            this.Close();
        }

        private void ServicesConfig_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }
